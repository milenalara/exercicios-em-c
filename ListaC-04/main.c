...
int options()
{
    ...
    printf("7 – Ler uma string de no máximo 50 caracteres e criar uma nova string com seu inverso, isso é a ultima letra da primeira string sera? a primeira na nova string e assim sucessivamente.\n");
