...
{
	printf("1 - Leia um conjunto indeterminado de palavras e ao final(estipule você um flag) informe qual foi a maior palavra e a menor palavra digitada, em tamanho e lexicograficamente.\n");
	char palavra[100], maiorLex[100], maiorTam[100];

//	scanf funciona em %c e %s, mas não pega os espaços em branco nas strings
//  gets só funciona para strings e pega os espaços em branco

	do {
	    printf("Informe uma palavra ou digite EXIT para encerrar o programa:\n");
	    scanf("%s", &palavra);
	} while (palavra != "EXIT");
