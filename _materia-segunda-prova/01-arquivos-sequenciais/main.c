...
void options()
{
	printf("1 - gravar em um arquivo os 64 primeiros valores da s�rie: 1 1 2 3 5 8 13 21 34 . . .");
	...
	printf("4 - leia um conjunto de valores (flag -1) e verifique para cada valor se ele se encontra ou n�o no arquivo gravado na letra a. Caso n�o exista dever� mostrar o valor anterior e o posterior a esse valor.");
}
...
// 1 - gravar em um arquivo os 64 primeiros valores da s�rie: 1 1 2 3 5 8 13 21 34 . . .
void soma()
{
	FILE *fibonacci;
